...
여러 행을 저장할 수 있는 변수 (List<Map>, List<Class>)
...
==> SELECT 쿼리의 결과를 변수에 담지않고 CURSOR를 통해 직접 메모리에 접근할 수 있다.
...
여러 행을 조회하는 SELECT 쿼리의 결과값을 저장하기 위해서 TABLE TYPE을 사용
...
명시적 커서와 FOR LOOP 결함 ==> 보다 사용하기 쉬운 형태
